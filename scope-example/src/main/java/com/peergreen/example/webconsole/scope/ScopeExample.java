...
package com.peergreen.example.webconsole.scope;
...
@Scope(name = "example", domains = "example", iconClass = "icon-info-circled") // Set 'domains' according to your console configuration
@Navigable
public class ScopeExample extends TabScope {
